...
BEGIN {
    ...
    require '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/test/default-and-jitter.cnf';
    shift;
