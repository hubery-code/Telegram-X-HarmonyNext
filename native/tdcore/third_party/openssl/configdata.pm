...
our %config = (
    ...
    "CFLAGS" => [
        "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -O2 -ffunction-sections -fdata-sections -fstack-protector-strong -D_FORTIFY_SOURCE=2"
    ],
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    "CXX" => "/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/llvm/bin/clang++",
    "CXXFLAGS" => [
        "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -O2"
    ],
    "FIPSKEY" => "f4556650ac31d35461610bac4ed81b1a181b2d8a43ea2854cbae22ca74560813",
    "FIPS_VENDOR" => "OpenSSL non-compliant FIPS Provider",
    "HASHBANGPERL" => "/usr/bin/env perl",
    "LDFLAGS" => [
        "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -Wl,-z,max-page-size=16384 -Wl,--build-id=sha1"
    ],
    "LDLIBS" => [],
    "OBJCOPY" => "objcopy",
    "PERL" => "perl",
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "enable-shared --prefix=/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/build/deps/openssl/arm64-v8a no-acvp-tests no-afalgeng no-apps no-aria no-asan no-async no-autoerrinit no-autoload-config no-brotli no-brotli-dynamic no-buildtest-c++ no-camellia no-capieng no-cast no-cms no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-docs no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-gost no-h3demo no-hqinterop no-http no-idea no-jitter no-ktls no-legacy no-loadereng no-md2 no-md4 no-mdc2 no-ml-dsa no-ml-kem no-msan no-nextprotoneg no-ocb no-ocsp no-padlockeng no-pie no-psk no-qlog no-quic no-rc2 no-rc5 no-sctp no-seed no-siphash no-siv no-slh-dsa no-sm2 no-sm3 no-sm4 no-srp no-ssl3 no-ssl3-method no-sslkeylog no-tests no-tfo no-trace no-ts no-ubsan no-unit-test no-unstable-qlog no-uplink no-weak-ssl-ciphers no-whirlpool no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "8",
    ...
    "perlargv" => [
        ...
        "no-fips",
        "no-padlockeng",
        "--prefix=/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/build/deps/openssl/arm64-v8a"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
        ...
        "BUILDFILE" => undef,
        "CC" => "/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/llvm/bin/clang",
        "CFLAGS" => "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -O2 -ffunction-sections -fdata-sections -fstack-protector-strong -D_FORTIFY_SOURCE=2",
        "CPP" => undef,
        "CPPDEFINES" => undef,
        "CPPFLAGS" => undef,
        "CPPINCLUDES" => undef,
        "CROSS_COMPILE" => undef,
        "CXX" => "/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/llvm/bin/clang++",
        "CXXFLAGS" => "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -O2",
        "HASHBANGPERL" => undef,
        "LD" => undef,
        "LDFLAGS" => "--target=aarch64-linux-ohos --sysroot=/Applications/DevEco-Studio.app/Contents/sdk/default/openharmony/native/sysroot -Wl,-z,max-page-size=16384 -Wl,--build-id=sha1",
        "LDLIBS" => undef,
        "MT" => undef,
        "MTFLAGS" => undef,
        "OBJCOPY" => undef,
    ...
    "dirinfo" => {
        ...
        "crypto/aes" => {
            "deps" => [
                ...
                "crypto/aes/libcrypto-shlib-bsaes-armv8.o",
        ...
        "crypto/chacha" => {
            "deps" => [
                ...
                "crypto/chacha/libcrypto-shlib-chacha-armv8-sve.o",
        ...
        "crypto/md5" => {
            "deps" => [
                ...
                "crypto/md5/libcrypto-shlib-md5-aarch64.o",
        ...
        "crypto/modes" => {
            "deps" => [
                ...
                "crypto/modes/libcrypto-shlib-aes-gcm-armv8-unroll8_64.o",
...
my %disabled_info = (
    ...
    "ml-dsa" => {
        "macro" => "OPENSSL_NO_ML_DSA"
    },
    "ml-kem" => {
        "macro" => "OPENSSL_NO_ML_KEM"
    },
    "msan" => {
...
unless (caller) {
    ...
    use lib '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/util/perl';
    use OpenSSL::fallback '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/mbjpeng-yu01/androidProjects/Telegram-X-HarmonyNext/native/tdcore/third_party/openssl/Configurations';
        use gentemplate;
